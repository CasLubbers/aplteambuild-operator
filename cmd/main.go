...
import (
	...
	"akamai.io/aplteambuild-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "00cc4daf.akamai.io",
	...
	if err := (&controller.AplTeamBuildReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "AplTeamBuild")
		os.Exit(1)
	}
